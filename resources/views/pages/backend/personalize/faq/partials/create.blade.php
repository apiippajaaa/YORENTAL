    ...
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <h2 class="text-xl font-semibold text-gray-800">
                {{ __('Tambah Frequently Asked Question') }}
            </h2>
        ...
        <form action="{{ route('faqs.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <textarea name="answer" id="answer" rows="4" required
                    class="mt-1 block w-full md:w-1/2 rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500"></textarea>
            </div>
